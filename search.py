...
def search():
    ...
    search_magnet_combobox.place(relx=0.5, rely=0.4, anchor="center", width = 300)
    
    search_ok_button = Button(search_app, text="OK", command=search_callback)
    search_ok_button.place(relx=0.5, rely=0.91, anchor="center")
