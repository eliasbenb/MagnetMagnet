...
class Ui_homeMainWindow(object):
    def setupUi(self, homeMainWindow):
        ...
        icon1 = QIcon()
        icon1.addPixmap(QPixmap(src.mglobals.x1377_icon), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addPixmap(QPixmap(src.mglobals.kat_icon), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addPixmap(QPixmap(src.mglobals.nyaa_icon), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addPixmap(QPixmap(src.mglobals.rarbg_icon), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addPixmap(QPixmap(src.mglobals.tpb_icon), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addPixmap(QPixmap(src.mglobals.website_icon), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addPixmap(QPixmap(src.mglobals.github_icon), QIcon.Normal, QIcon.Off)
