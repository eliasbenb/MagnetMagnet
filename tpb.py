...
def tpb():
    ...
    def load_config():
        ...
        with open(path+"\\tpb_config.env", "r") as r1:
    ...
    def save_config():
        ...
        category = category_entry.get()
        clipboard = clipboard_combobox.get()
        with open(path+"\\tpb_config.env", "w") as w2:
            w2.write(domain+'\n'+category+'\n'+clipboard)
    
    app = Tk()

    domain_text = StringVar(app, value="https://tpb.party/")
    domain_label = Label(app, text="Enter TPB Domain Link:")
